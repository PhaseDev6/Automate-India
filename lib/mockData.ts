export const vehicles = [
  { id: 'TRK-042', type: 'Compactor', route: 'Alpha 1 - Block A', status: 'On route', fuel: '78%', driver: 'Meera Patel', updated: '2 min ago', lat: 28.4735, lng: 77.5015, startLat: 28.4710, startLng: 77.4980, targetLat: 28.4750, targetLng: 77.5000 },
  { id: 'TRK-018', type: 'Roll-off', route: 'Commercial Belt', status: 'On route', fuel: '64%', driver: 'Arjun Sharma', updated: '5 min ago', lat: 28.4715, lng: 77.5040, startLat: 28.4690, startLng: 77.5010, targetLat: 28.4730, targetLng: 77.5020 },
  { id: 'TRK-031', type: 'Rear loader', route: 'C Market', status: 'At depot', fuel: '92%', driver: 'Ananya Singh', updated: '8 min ago', lat: 28.4705, lng: 77.5005, startLat: 28.4705, startLng: 77.5005, targetLat: 28.4705, targetLng: 77.5005 },
  ...
  { id: 'TRK-006', type: 'Sweeper', route: 'Knowledge Park', status: 'On route', fuel: '55%', driver: 'Vikram Kumar', updated: '22 min ago', lat: 28.4780, lng: 77.4950, startLat: 28.4780, startLng: 77.4910, targetLat: 28.4725, targetLng: 77.5050 },
]
